        ...
        <div className='rounded-xl overflow-hidden mt-2 drop-shadow-[0_0_10px_rgba(0,0,0,0.4)]'>
            ...
            <div className='bg-white px-4 pt-3 pb-4 flex flex-col gap-3'>
                <div>
                    ...
                    <p className='text-[#808080] text-xl font-semibold'>{distanceKm.toFixed(2)} KM</p>
                ...
                <div>
                    ...
                    <p className='text-dark-blue text-3xl font-extrabold'>{calculatedPrice.toFixed(2)} TL</p>
                </div>

                <button
                    onClick={onAccept}
                    disabled={loading}
                    className='btn-hover-shadow w-full bg-primary-blue text-white rounded px-4 py-3 font-extrabold text-base tracking-widest uppercase disabled:opacity-50 flex items-center justify-center gap-2'
                >
